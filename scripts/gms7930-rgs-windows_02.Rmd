...
We will demostrate how to analyze ChIP-seq data under R environment, from peak detection to peak annotation. We will summarize the characteristics of the given ChIP-seq dataset and report/visualize ChIP-seq profile related to individual genes.
...
workdir = '~/' ## 
download.file('https://github.com/chingyaousf/Regulatory-Genomic-Sequencing-ChIP-seq-data-analysis/raw/main/data/Gm12878Control.bam',paste0(workdir,'Gm12878Control.bam'))
download.file('https://github.com/chingyaousf/Regulatory-Genomic-Sequencing-ChIP-seq-data-analysis/raw/main/data/Gm12878Control.bam.bai',paste0(workdir,'Gm12878Control.bam.bai'))
download.file('https://github.com/chingyaousf/Regulatory-Genomic-Sequencing-ChIP-seq-data-analysis/raw/main/data/Gm12878Ctcf.bam',paste0(workdir,'Gm12878Ctcf.bam'))
download.file('https://github.com/chingyaousf/Regulatory-Genomic-Sequencing-ChIP-seq-data-analysis/raw/main/data/Gm12878Ctcf.bam.bai',paste0(workdir,'Gm12878Ctcf.bam.bai'))
download.file('https://github.com/chingyaousf/Regulatory-Genomic-Sequencing-ChIP-seq-data-analysis/raw/main/data/preloadforwindows.rda',paste0(workdir,'preloadforwindows.rda'))
```
